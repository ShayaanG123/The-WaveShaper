...
module tb_osc_triangle;
    ...
    initial begin
        $readmemh("/afs/ece.cmu.edu/usr/shayaang/Private/18500/Oscillators/Matlab_Verification/Matlab_Hex/triangle_golden.hex", golden_ref);
        ...
        for (int i = 0; i < 1024; i++) begin
            ...
            if (tri_out !== golden_ref[i]) begin
                $display("MISMATCH @ Sample %0d | RTL: %h | Golden: %h", i, tri_out, golden_ref[i]);
                errors++;
            end
        end
