...
module tb_osc_saw;
    ...
    initial begin
        $readmemh("/afs/ece.cmu.edu/usr/shayaang/Private/18500/Oscillators/Matlab_Verification/Matlab_Hex/saw_golden.hex", golden_ref);
        ...
        for (int i = 0; i < 1024; i++) begin
            ...
            if (saw_out !== golden_ref[i]) begin
                $display("MISMATCH @ Sample %0d | RTL: %h | Golden: %h", i, saw_out, golden_ref[i]);
                errors++;
            end
        end
