...
timeunit 1ns; 
timeprecision 100ps;
//NB: current scaling takes about 7M cycles/phase-completion
//
//
//This test ensures that early release transitions to release immediately upon
//detrigger. Key to the test: Release shouldn't jump to sustain_level
module tb_ADSR();
